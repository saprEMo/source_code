...
Dfinal_zeff_tot_dlog =Dfinal_zeff_tot/dlog
Ffinal_zeff_tot_dlog =Ffinal_zeff_tot/dlogF

valuesHist_zeff_tot, bins = np.histogram(Dfinal_zeff_tot_dlog, weights=Nrel_tot_zeff, normed=False)
valuesHist_zeff_totF, binsF = np.histogram(Ffinal_zeff_tot_dlog, weights=Nrel_tot_zeff, normed=False)
...
weights_zeff_tot = Nrel_tot_zeff
...
with open(nameFile_zeff_OUT, 'w') as f1:
    ...
    writer.writerows(zip(Dfinal_zeff_p_dlog,Nrel_p_zeff,Dfinal_zeff_t_dlog,Nrel_t_zeff))
...
with open(nameFile_FLUXzeff_OUT, 'w') as f3:
    ...
    writer.writerows(zip(Ffinal_zeff_p_dlog,Nrel_p_zeff,Ffinal_zeff_t_dlog,Nrel_t_zeff))
print
